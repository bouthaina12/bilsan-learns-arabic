      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="text-center lg:text-right flex-1 max-w-2xl animate-fade-in">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-6 font-arabic leading-tight">
              سلسلة <span className="text-primary">بيلسان</span> التعليمية
            </h1>
            
            <p className="text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 font-arabic leading-relaxed">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-6 mt-10">
              {[
                ...
                <div key={index} className="text-center px-4">
                  <div className="text-2xl md:text-3xl font-bold text-primary font-arabic">
                    {stat.number}
                  </div>
